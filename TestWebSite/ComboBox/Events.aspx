...
<HTML>
	...
	<body>
		...
		<form name="myForm" runat="server">
			...
			<opgeek:ComboBox id="simpsons" onselectedindexchanged="ComboSelectionChanged" ontextchanged="ComboTextChanged" runat="server" autopostback="true">
			...
			<opgeek:ComboBox id="flintstones" onselectedindexchanged="ComboSelectionChanged" ontextchanged="ComboTextChanged" runat="server" autopostback="true">
				<asp:listitem Text="Fred" />
				<asp:listitem Text="Wilma" />
				<asp:listitem Text="Barney" />
				<asp:listitem Text="Betty" />
			</opgeek:ComboBox>
