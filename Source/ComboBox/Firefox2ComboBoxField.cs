...
{
    internal class Firefox2ComboBoxField : DefaultComboBoxField
    {
        //============================================================
        // Private Data
        //============================================================
...
// ReSharper restore ValueParameterNotUsed
        ...
        protected override void OnPreRender (EventArgs e)
        {
            ...
            Page.ClientScript.RegisterStartupScript (typeof (Firefox2ComboBoxField), UniqueID, BuildClientScriptBlock (initialisationCode));
        ...
        {
            return ComboBoxConstants.Firefox2DhtmlResource;
        }
    }
}