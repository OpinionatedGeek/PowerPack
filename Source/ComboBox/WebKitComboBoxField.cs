...
{
    [ParseChildren (false)]
    internal class WebKitComboBoxField : DefaultComboBoxField
    {
        //============================================================
        // Private Data
        //============================================================
...
";
        ...
        protected override void OnPreRender (EventArgs e)
        {
            ...
            Page.ClientScript.RegisterStartupScript (typeof (IE7ComboBoxField), UniqueID, BuildClientScriptBlock (initialisationCode));
        ...
        {
            return ComboBoxConstants.WebKitDhtmlResource;
        }
    }
}
