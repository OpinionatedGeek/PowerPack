...
namespace OpinionatedGeek.Web.PowerPack.Licensing
{
    ...
    /// Ignored
    /// </summary>
    internal class PopupAutomaticallyLicenseProvider : PowerPackLicenseProvider
    {
        //============================================================
        // Private Data
        //============================================================

        private const string AlternativeProductName = "PowerPackPopupAutomatically";
        ...
        /// Ignored
        /// </summary>
        public PopupAutomaticallyLicenseProvider ()
        {
            return;
        }
