...
namespace OpinionatedGeek.Web.PowerPack.Licensing
{
    ...
    /// Ignored
    /// </summary>
    internal class PopupLinkButtonLicenseProvider : PowerPackLicenseProvider
    {
        //============================================================
        // Private Data
        //============================================================

        private const string AlternativeProductName = "PowerPackPopupLinkButton";
        ...
        /// Ignored
        /// </summary>
        public PopupLinkButtonLicenseProvider ()
        {
            return;
        }
