...
namespace OpinionatedGeek.Web.PowerPack
{
    ///
    /// <summary>
    /// A standard LinkButton that has been enhanced to display a popup or confirmation message when pressed.
    /// <p class="i1" style="color: #0206A6">
    /// <b>Browser Requirements:</b> Client-side Javascript must be available and enabled.
    /// </p>
    /// </summary>
    /// <remarks>
    /// This control behaves exactly like the regular ASP.NET LinkButton with one exception: it can display a popup
    ...
    /// <p class="i1">
    /// The PopupLinkButton allows two modes, <b>AlertOnly</b> and <b>Confirm</b>.  These modes are configured
    ...
    /// Javascript is not available, this control reverts to the default LinkButton behaviour.
    /// </p>
    /// </remarks>
    /// <example>
    /// The following code declares the tag for use on the page via the Register directive, and then adds a
    /// PopupLinkButton with the text 'Press Me!' which will bring up the alert 'This is an alert!'.
    /// <code>
    /// &lt;%@ Register TagPrefix="opgeek"
    ///     Namespace="OpinionatedGeek.Web.PowerPack"
    ///     Assembly="OpinionatedGeek.Web.PowerPack"%&gt;
    /// ...
    /// &lt;opgeek:PopupLinkButton
    ///     id="popupbutton"
    ///     AlertOnly="True"
    ///     text="Press Me!"
    ...
    /// href="http://www.opinionatedgeek.com/DotNet/Products/PowerPack/Examples/PopupLinkButton.aspx">here</a>
    /// for a live demonstration of the control.
    /// </p>
    /// </example>
    ///
    [DefaultProperty ("Text")]
    [ToolboxData ("<{0}:PopupLinkButton runat=server></{0}:PopupLinkButton>")]
    [ToolboxBitmap (typeof (LinkButton))]
    [LicenseProvider (typeof (PopupLinkButtonLicenseProvider))]
    public class PopupLinkButton : LinkButton
    {
        ...
        internal const string ProductName = "PopupLinkButton";
        ...
        ///
        /// <summary>
        /// Initializes a new instance of the <see cref="PopupLinkButton"/> class.
        /// </summary>
        /// <remarks>
        /// Use this constructor to create and initialize a new instance of the <see cref="PopupLinkButton"/> class.
        /// This default constructor initializes all fields to their default values.
        /// </remarks>
        ///
        public PopupLinkButton ()
        {
            _license = LicenseManager.Validate (typeof (PopupLinkButton), this);
