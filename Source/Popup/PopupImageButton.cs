...
namespace OpinionatedGeek.Web.PowerPack
{
    ///
    /// <summary>
    /// A standard ImageButton that has been enhanced to display a popup or confirmation message when pressed.
    /// <p class="i1" style="color: #0206A6">
    /// <b>Browser Requirements:</b> Client-side Javascript must be available and enabled.
    /// </p>
    /// </summary>
    /// <remarks>
    /// This control behaves exactly like the regular ASP.NET ImageButton with one exception: it can display a popup
    ...
    /// <p class="i1">
    /// The PopupImageButton allows two modes, <b>AlertOnly</b> and <b>Confirm</b>.  These modes are configured
    ...
    /// Javascript is not available, this control reverts to the default ImageButton behaviour.
    /// </p>
    /// </remarks>
    /// <example>
    /// The following code declares the tag for use on the page via the Register directive, and then adds a
    /// PopupImageButton with the image '/images/opgeek.gif' which will bring up the alert 'This is an alert!'.
    /// <code>
    /// &lt;%@ Register TagPrefix="opgeek"
    ///     Namespace="OpinionatedGeek.Web.PowerPack"
    ///     Assembly="OpinionatedGeek.Web.PowerPack"%&gt;
    /// ...
    /// &lt;opgeek:PopupImageButton
    ///     id="popupbutton"
    ///     AlertOnly="False"
    ///     ImageUrl="/images/opgeek.gif"
    ///     popuptext="This is an alert!"
    ///     runat="server"/&gt;
    /// </code>
    /// <p class="i1" style="color: #0206A6; background-color: #FFFFCC; padding: 0.5em 1em 0.5em 1em; border-width: 1px; border-style: solid; border-color: #999999;">
    /// <b>Live demo!</b> Click <a target="_new"
    /// href="http://www.opinionatedgeek.com/DotNet/Products/PowerPack/Examples/PopupImageButton.aspx">here</a>
    /// for a live demonstration of the control.
    /// </p>
    /// </example>
    ///
    [DefaultProperty ("ImageUrl")]
    [ToolboxData ("<{0}:PopupImageButton runat=server></{0}:PopupImageButton>")]
    [ToolboxBitmap (typeof (ImageButton))]
    [LicenseProvider (typeof (PopupImageButtonLicenseProvider))]
    public class PopupImageButton : ImageButton
    {
        //============================================================
        // Private Data
        //============================================================

        internal const string ProductName = "PopupImageButton";
        ...
        ///
        /// <summary>
        /// Initializes a new instance of the <see cref="PopupImageButton"/> class.
        /// </summary>
        /// <remarks>
        /// Use this constructor to create and initialize a new instance of the <see cref="PopupImageButton"/> class.
        /// This default constructor initializes all fields to their default values.
        /// </remarks>
        ///
        public PopupImageButton ()
        {
            _license = LicenseManager.Validate (typeof (PopupImageButton), this);
