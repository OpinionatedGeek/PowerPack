...
{
    internal class MozRTField : WysiwygRTField
    {
        //============================================================
        // Private Data
        //============================================================
        ...
        private const string MozGetTextBox = @"<script language=""Javascript"">
        ...
        public MozRTField (RichTextBox controller) : base (controller)
        {
            return;
        }
        ...
        protected override string GetEditFrame ()
        {
            ...
            string prompt = (_controller.Page.IsPostBack ? String.Empty : "<div style=\"" + style + "\">" + _controller.Prompt + "</div>");
...
";
        ...
        {
            return RTConstants.MozDhtmlResource;
        }

        public override void PromptScriptRequired ()
        {
            Controller.Page.ClientScript.RegisterClientScriptBlock (typeof (MozRTField), PromptScriptKey, PromptScript);
            Controller.Page.ClientScript.RegisterClientScriptBlock (typeof (MozRTField), GetTextBoxKey, MozGetTextBox);
