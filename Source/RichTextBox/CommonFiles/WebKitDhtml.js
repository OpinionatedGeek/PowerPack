	...
	if (this.Activated)
	{
		...
		try
		{
			...
			if ((this.CurrentFontColor ==  null) || (this.CurrentFontColor == ''))
			{
				...
				this.SetColorDropdown (COMMAND_NAME_FONTCOLOR_RTB_OPGEEK, this.CurrentFontColor, 'color');
				this.SetFontColor ();
			}
			else
			{
			...
			if ((this.CurrentBackColor ==  null) || (this.CurrentBackColor == ''))
			{
				...
				this.SetColorDropdown (COMMAND_NAME_BACKCOLOR_RTB_OPGEEK, this.CurrentBackColor, 'backgroundColor');
				this.SetBackColor ();
			}
			else
			{
...
RichText_rtb_opgeek.prototype.SetColorDropdown = function (szDropdownName, szState, szColorPropertyToSet)
{
	if (this.Activated)
	{
		...
		if (control != null)
		{
			if (szState == '')
			{
				...
				control.style [szColorPropertyToSet] = control.options [0].value;
			}
			else
			{
				...
				if (nDefiniteMatchAt != -1)
				{
					...
					control.style [szColorPropertyToSet] = szState;
				}
				else
				{
