...
var imgNormalButton_rtb_opgeek = new Object ();
imgNormalButton_rtb_opgeek.src = 'button_normal.gif';
var imgUpButton_rtb_opgeek = new Object ();
imgUpButton_rtb_opgeek.src = 'button_up.gif';
var imgDownButton_rtb_opgeek = new Object ();
imgDownButton_rtb_opgeek.src = 'button_down.gif';
...
)
{
	...
	imgNormalButton_rtb_opgeek.src = szButtonNormalImageUrl;
	imgUpButton_rtb_opgeek.src = szButtonUpImageUrl;
	imgDownButton_rtb_opgeek.src = szButtonDownImageUrl;
...
)
{
	if (document.images)
	{
		var szExistingSource = document [szImageTagName].src;
		var szNewSource = imgNewImageObject.src;
		if (szExistingSource.substring (szExistingSource.length - szNewSource.length) != szNewSource)
		{
			document [szImageTagName].src = imgNewImageObject.src;
		}
	}
