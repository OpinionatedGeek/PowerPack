...
{
    internal class Firefox2RTField : WysiwygRTField
    {
        //============================================================
        // Private Data
        //============================================================
        ...
        private const string Firefox2GetTextBox = @"<script language=""Javascript"">
        ...
        public Firefox2RTField (RichTextBox controller)
            : base (controller)
        {
            return;
        }
        ...
        {
            const string FrameTemplate = "\n<textarea name=\"{1}\" id=\"{0}\" cols=\"40\" rows=\"15\" style=\"display: none;\">{3}</textarea>\n<iframe src=\"{4}\" name=\"{1}FrameName\" id=\"{1}FrameID\" width=\"{5}\" height=\"{6}\" style=\"{8}{9}{10}\" class=\"{2}\"></iframe><br /><div id=\"{1}ContentID\" style=\"display: none\"><div style=\"{10}\">{3}</div></div><div id=\"{1}PromptID\" style=\"display: none\">{7}</div>";
...
";
            ...
            activation.Append (contentSettor);
        ...
        {
            return RTConstants.Firefox2DhtmlResource;
        }

        protected override string GetButtonDown ()
        {
            return _controller.Page.ClientScript.GetWebResourceUrl (typeof (Firefox2RTField), RTConstants.ButtonDownOverlayResource);
        }

        protected override string GetButtonUp ()
        {
            return _controller.Page.ClientScript.GetWebResourceUrl (typeof (Firefox2RTField), RTConstants.ButtonUpOverlayResource);
        }
        ...
        {
            Controller.Page.ClientScript.RegisterClientScriptBlock (typeof (Firefox2RTField), PromptScriptKey, PromptScript);
            Controller.Page.ClientScript.RegisterClientScriptBlock (typeof (Firefox2RTField), GetTextBoxKey, Firefox2GetTextBox);
