...
namespace OpinionatedGeek.Web.PowerPack.Licensing
{
    ...
    /// Ignored
    /// </summary>
    internal class MakeMeHomePageAutomaticallyLicenseProvider : PowerPackLicenseProvider
    {
        //============================================================
        // Private Data
        //============================================================

        private const string AlternativeProductName = "PowerPackMakeMeHomePageAutomatically";
        ...
        /// Ignored
        /// </summary>
        public MakeMeHomePageAutomaticallyLicenseProvider ()
        {
            return;
        }
