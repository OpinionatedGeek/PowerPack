...
namespace OpinionatedGeek.Web.PowerPack
{
    ///
    /// <summary>
    /// A special button that allows the user to set the browser's home page to the current page.
    /// <p class="i1" style="color: #0206A6">
    /// <b>Browser Requirements:</b> IE5 or higher.
    /// </p>
    /// </summary>
    /// <remarks>
    /// The theory is simple - add this control to your page, and the user sees a button marked
    /// 'Make me your home page' that allows them to set the browser's home page to the current page.
    ...
    /// MakeMeHomePageButton button with the text 'Make OpinionatedGeek.com your home page'.
    /// <code>
    /// &lt;%@ Register TagPrefix="opgeek"
    ///     Namespace="OpinionatedGeek.Web.PowerPack"
    ///     Assembly="OpinionatedGeek.Web.PowerPack"%&gt;
    /// ...
    /// &lt;opgeek:MakeMeHomePageButton
    ///     id="homepagesetter"
    ///     text="Make this page your home page!"
    ///     runat="server"/&gt;
    /// </code>
    /// <p class="i1" style="color: #0206A6; background-color: #FFFFCC; padding: 0.5em 1em 0.5em 1em; border-width: 1px; border-style: solid; border-color: #999999;">
    /// <b>Live demo!</b> Click <a target="_new"
    /// href="http://www.opinionatedgeek.com/DotNet/Products/PowerPack/Examples/MakeMeHomePageButton.aspx">here</a>
    /// for a live demonstration of the control.
    /// </p>
    /// </example>
    ///
    [LicenseProvider (typeof (MakeMeHomePageButtonLicenseProvider))]
    [ToolboxBitmap (typeof (Button))]
    [ToolboxData ("<{0}:MakeMeHomePageButton runat=server></{0}:MakeMeHomePageButton>")]
    public class MakeMeHomePageButton : Button
    {
        //============================================================
        // Private Data
        //============================================================

        internal const string ProductName = "MakeMeHomePageButton";
        ...
        ///
        /// <summary>
        /// Initializes a new instance of the <see cref="MakeMeHomePageButton"/> class.
        /// </summary>
        /// <remarks>
        /// Use this constructor to create and initialize a new instance of the <see cref="MakeMeHomePageButton"/> class.
        /// This default constructor initializes all fields to their default values.
        /// </remarks>
        ///
        public MakeMeHomePageButton ()
        {
            _license = LicenseManager.Validate (typeof (MakeMeHomePageButton), this);
