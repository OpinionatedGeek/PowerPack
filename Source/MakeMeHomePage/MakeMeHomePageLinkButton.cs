...
namespace OpinionatedGeek.Web.PowerPack
{
    ///
    /// <summary>
    /// A special LinkButton that allows the user to set the browser's home page to the current page.
    /// <p class="i1" style="color: #0206A6">
    /// <b>Browser Requirements:</b> IE5 or higher.
    /// </p>
    /// </summary>
    /// <remarks>
    /// The theory is simple - add this control to your page, and the user sees a LinkButton marked
    ...
    /// MakeMeHomePageLinkButton button with the text 'Make OpinionatedGeek.com your home page'.
    /// <code>
    /// &lt;%@ Register TagPrefix="opgeek"
    ///     Namespace="OpinionatedGeek.Web.PowerPack"
    ///     Assembly="OpinionatedGeek.Web.PowerPack"%&gt;
    /// ...
    /// &lt;opgeek:MakeMeHomePageLinkButton
    ///     id="homepagesetter"
    ...
    /// href="http://www.opinionatedgeek.com/DotNet/Products/PowerPack/Examples/MakeMeHomePageLinkButton.aspx">here</a>
    /// for a live demonstration of the control.
    /// </p>
    /// </example>
    ///
    [LicenseProvider (typeof (MakeMeHomePageLinkButtonLicenseProvider))]
    [ToolboxBitmap (typeof (LinkButton))]
    public class MakeMeHomePageLinkButton : LinkButton
    {
        //============================================================
        // Private Data
        //============================================================

        internal const string ProductName = "MakeMeHomePageLinkButton";
        ...
        ///
        /// <summary>
        /// Initializes a new instance of the <see cref="MakeMeHomePageLinkButton"/> class.
        /// </summary>
        /// <remarks>
        /// Use this constructor to create and initialize a new instance of the <see cref="MakeMeHomePageLinkButton"/> class.
        /// This default constructor initializes all fields to their default values.
        /// </remarks>
        ///
        public MakeMeHomePageLinkButton ()
        {
            _license = LicenseManager.Validate (typeof (MakeMeHomePageLinkButton), this);
