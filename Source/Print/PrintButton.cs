...
namespace OpinionatedGeek.Web.PowerPack
{
    ///
    /// <summary>
    /// A special button that allows the user to print the current page.
    /// <p class="i1" style="color: #0206A6">
    /// <b>Browser Requirements:</b> Client-side Javascript must be available and enabled.
    /// </p>
    /// </summary>
    /// <remarks>
    /// The theory is simple - add this button to your page, and the user sees a button marked
    ...
    /// print button with the text 'Print Me'.
    /// <code>
    ...
    /// href="http://www.opinionatedgeek.com/DotNet/Products/PowerPack/Examples/PrintButton.aspx">here</a>
    /// for a live demonstration of the control.
    /// </p>
    /// </example>
    ///
    [LicenseProvider (typeof (PrintButtonLicenseProvider))]
    ...
    public class PrintButton : Button
    {
        ...
        internal const string ProductName = "PrintButton";
