...
namespace OpinionatedGeek.Web.PowerPack.Licensing
{
    ...
    /// Ignored
    /// </summary>
    internal class PrintButtonLicenseProvider : PowerPackLicenseProvider
    {
        //============================================================
        // Private Data
        //============================================================

        private const string AlternativeProductName = "PowerPackPrintButton";
        ...
        /// Ignored
        /// </summary>
        public PrintButtonLicenseProvider ()
        {
            return;
        }
