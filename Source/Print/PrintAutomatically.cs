...
namespace OpinionatedGeek.Web.PowerPack
{
    ///
    /// <summary>
    /// A special invisible control that automatically prompts the user to print the current page.  This can be useful
    /// for pages that are invoices, for example.
    /// <p class="i1" style="color: #0206A6">
    /// <b>Browser Requirements:</b> Client-side Javascript must be available and enabled.
    /// </p>
    /// </summary>
    /// <remarks>
    /// Adding this control to a page automatically brings up the 'Print' dialog when the page is loaded.  Note it
    /// is not possible to print from a browser without going through this dialog - there is no way to 'force'
    /// printing without user authorisation.
    ...
    /// <b>Browser Notes:</b> 
    /// This control requires client-side Javascript to work as expected.
    /// </p>
    /// </remarks>
    /// <example>
    /// The following code declares the tag for use on the page via the Register directive, and then adds an
    /// PrintAutomatically control.
    /// <code>
    /// &lt;%@ Register TagPrefix="opgeek"
    ///     Namespace="OpinionatedGeek.Web.PowerPack"
    ///     Assembly="OpinionatedGeek.Web.PowerPack"%&gt;
    /// ...
    /// &lt;opgeek:PrintAutomatically
    ///     id="printer"
    ///     runat="server"/&gt;
    /// </code>
    /// <p class="i1" style="color: #0206A6; background-color: #FFFFCC; padding: 0.5em 1em 0.5em 1em; border-width: 1px; border-style: solid; border-color: #999999;">
    /// <b>Live demo!</b> Click <a target="_new"
    /// href="http://www.opinionatedgeek.com/DotNet/Products/PowerPack/Examples/PrintAutomatically.aspx">here</a>
    /// for a live demonstration of the control.
    /// </p>
    /// </example>
    ///
    [LicenseProvider (typeof (PrintAutomaticallyLicenseProvider))]
    [Designer (typeof (AutomaticDesigner))]
    public class PrintAutomatically : WebControl
    {
        //============================================================
        // Private Data
        //============================================================

        internal const string ProductName = "PrintAutomatically";
        ...
        ///
        /// <summary>
        /// Initializes a new instance of the <see cref="PrintAutomatically"/> class.
        /// </summary>
        /// <remarks>
        /// Use this constructor to create and initialize a new instance of the <see cref="PrintAutomatically"/> class.
        /// This default constructor initializes all fields to their default values.
        /// </remarks>
        ///
        public PrintAutomatically ()
        {
            _license = LicenseManager.Validate (typeof (PrintAutomatically), this);
        ...
        protected override void OnPreRender (EventArgs e)
        {
            ...
            if (Enabled)
            {
                PrintAction.RegisterStartupScript (Page);
            }
