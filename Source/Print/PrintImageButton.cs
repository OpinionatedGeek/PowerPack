...
namespace OpinionatedGeek.Web.PowerPack
{
    ///
    /// <summary>
    /// A special ImageButton that allows the user to print the current page.
    /// <p class="i1" style="color: #0206A6">
    /// <b>Browser Requirements:</b> Client-side Javascript must be available and enabled.
    /// </p>
    /// </summary>
    /// <remarks>
    /// The theory is simple - add this button to your page, and the user sees an ImageButton marked
    /// 'Print' that allows them to print the page.
    ...
    /// print ImageButton with the image '/images/printer.gif'.
    /// <code>
    /// &lt;%@ Register TagPrefix="opgeek"
    ///     Namespace="OpinionatedGeek.Web.PowerPack"
    ///     Assembly="OpinionatedGeek.Web.PowerPack"%&gt;
    /// ...
    /// &lt;opgeek:PrintImageButton
    ///     id="printer"
    ...
    /// href="http://www.opinionatedgeek.com/DotNet/Products/PowerPack/Examples/PrintImageButton.aspx">here</a>
    /// for a live demonstration of the control.
    /// </p>
    /// </example>
    ///
    [LicenseProvider (typeof (PrintImageButtonLicenseProvider))]
    [ToolboxBitmap (typeof (ImageButton))]
    public class PrintImageButton : ImageButton
    {
        //============================================================
        // Private Data
        //============================================================

        internal const string ProductName = "PrintImageButton";
        ...
        ///
        /// <summary>
        /// Initializes a new instance of the <see cref="PrintImageButton"/> class.
        /// </summary>
        /// <remarks>
        /// Use this constructor to create and initialize a new instance of the <see cref="PrintImageButton"/> class.
        /// This default constructor initializes all fields to their default values.
        /// </remarks>
        ///
        public PrintImageButton ()
        {
            _license = LicenseManager.Validate (typeof (PrintImageButton), this);
        ...
        protected override void Render (HtmlTextWriter writer)
        {
            ...
            {
                ImageUrl = Page.ClientScript.GetWebResourceUrl (typeof (PrintImageButton), PrintConstants.IconResource);
            }
