...
namespace OpinionatedGeek.Web.PowerPack.Licensing
{
    ...
    /// Ignored
    /// </summary>
    internal class ShowOnConditionClientSideLicenseProvider : PowerPackLicenseProvider
    {
        //============================================================
        // Private Data
        //============================================================

        private const string AlternativeProductName = "PowerPackShowOnConditionClientSide";
        ...
        /// Ignored
        /// </summary>
        public ShowOnConditionClientSideLicenseProvider ()
        {
            return;
        }
