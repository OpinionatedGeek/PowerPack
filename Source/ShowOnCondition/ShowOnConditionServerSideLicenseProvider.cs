...
namespace OpinionatedGeek.Web.PowerPack.Licensing
{
    ...
    /// Ignored
    /// </summary>
    internal class ShowOnConditionServerSideLicenseProvider : PowerPackLicenseProvider
    {
        //============================================================
        // Private Data
        //============================================================

        private const string AlternativeProductName = "PowerPackShowOnConditionServerSide";
        ...
        /// Ignored
        /// </summary>
        public ShowOnConditionServerSideLicenseProvider ()
        {
            return;
        }
