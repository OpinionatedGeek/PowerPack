...
namespace OpinionatedGeek.Web.PowerPack
{
    ///
    /// <summary>
    /// A Panel-type control that only displays its contents if the user is authenticated.
    /// <p class="i1" style="color: #003399">
    /// <b>Browser Requirements:</b> None.
    /// </p>
    /// </summary>
    /// <remarks>
    /// This control gives you a simple way to show some page content <i>only</i> to users who have logged in.  You
    /// can use this control to provide a user-based greeting, or to provide links to content only available to
    /// subscribers.
    /// <p class="i1">
    /// This control works well when used in conjunction with the <see cref="ShowIfNotLoggedIn"/> control.
    /// </p>
    ...
    /// ShowIfLoggedIn control which displays the current username, but only if the user is logged in.
    /// <code>
    ...
    /// href="http://www.opinionatedgeek.com/DotNet/Products/PowerPack/Examples/ShowIfLoggedIn.aspx">here</a>
    /// for a live demonstration of the control.
    /// </p>
    /// </example>
    ///
    [LicenseProvider (typeof (ShowIfLoggedInLicenseProvider))]
    [Designer (typeof (AutomaticDesigner))]
    [ToolboxBitmap (typeof (Panel))]
    [ParseChildren (false)]
    public class ShowIfLoggedIn : WebControl
    {
        //============================================================
        // Private Data
        //============================================================

        internal const string ProductName = "ShowIfLoggedIn";
        ...
        ///
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowIfLoggedIn"/> class.
        /// </summary>
        /// <remarks>
        /// Use this constructor to create and initialize a new instance of the <see cref="ShowIfLoggedIn"/> class.
        /// This default constructor initializes all fields to their default values.
        /// </remarks>
        ///
        public ShowIfLoggedIn () : base (HtmlTextWriterTag.Span)
        {
            _license = LicenseManager.Validate (typeof (ShowIfLoggedIn), this);
