...
namespace OpinionatedGeek.Web.PowerPack.Licensing
{
    ...
    /// Ignored
    /// </summary>
    internal class ShowIfNotLoggedInLicenseProvider : PowerPackLicenseProvider
    {
        //============================================================
        // Private Data
        //============================================================

        private const string AlternativeProductName = "PowerPackShowIfNotLoggedIn";
        ...
        /// Ignored
        /// </summary>
        public ShowIfNotLoggedInLicenseProvider ()
        {
            return;
        }
